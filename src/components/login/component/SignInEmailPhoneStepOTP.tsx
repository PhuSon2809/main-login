...
const SignInEmailPhoneStepOTP = ({ email, onBack }: EmailPhoneStepOTPProps) => {
    ...
    <>
      <div className={classNames('w-full h-full flex flex-col', modalSuccess && 'blur-lg')}>
        <Container className='py-5 flex flex-col gap-5 text-[#0D0D0D] text-[1.25rem]/[1.5rem]'>
          <span className='text-[600] font-bold'>Verify with OTP</span>
...
export default SignInEmailPhoneStepOTP
